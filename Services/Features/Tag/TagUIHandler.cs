...
namespace OoiMRR.Services.Tag
{
    ...
    public class TagUIHandler
    {
        ...
        /// 更新标签选择状态
        /// </summary>
        /// <param name="selectedItems">选中的文件项列表</param>
        public void UpdateTagSelectionState(List<FileSystemItem> selectedItems)
        {
            // 此方法用于在选中文件变化时更新标签面板的选中状态
            // 目前 TagTrain 面板可能不直接支持从外部设置选中态，或者需要通过 TagTrainEventHandler 处理
            // 暂时留空，避免编译错误
        }
        ...
        /// 显示批量打标签对话框
        /// </summary>
        /// <param name="files">要打标签的文件列表</param>
