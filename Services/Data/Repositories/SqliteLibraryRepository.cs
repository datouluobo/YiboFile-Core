...
namespace YiboFile.Services.Data.Repositories
{
    ...
    public class SqliteLibraryRepository : ILibraryRepository
    {
        ...
        public SqliteLibraryRepository(string connectionString = null)
        {
        ...
        public async Task<int> AddLibraryAsync(string name)
        {
            using var connection = new SqliteConnection(_connectionString);
            ...
            using var maxOrderCommand = connection.CreateCommand();
            maxOrderCommand.CommandText = "SELECT COALESCE(MAX(DisplayOrder), 0) FROM Libraries";
            var maxOrder = Convert.ToInt32(await maxOrderCommand.ExecuteScalarAsync());
        ...
        public void UpdateLibraryName(int libraryId, string newName)
        {
            using var connection = new SqliteConnection(_connectionString);
            connection.Open();
        ...
        public async Task UpdateLibraryNameAsync(int libraryId, string newName)
        {
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
            using var command = connection.CreateCommand();
        ...
        public async Task MoveLibraryUpAsync(int libraryId)
        {
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
            ...
            getCurrentCommand.CommandText = "SELECT DisplayOrder FROM Libraries WHERE Id = @id";
            getCurrentCommand.Parameters.AddWithValue("@id", libraryId);
            var currentOrder = await getCurrentCommand.ExecuteScalarAsync();
            ...
            getPrevCommand.CommandText = "SELECT Id, DisplayOrder FROM Libraries WHERE DisplayOrder < @order ORDER BY DisplayOrder DESC LIMIT 1";
            getPrevCommand.Parameters.AddWithValue("@order", currentOrderValue);
            using var prevReader = await getPrevCommand.ExecuteReaderAsync();
        ...
        public void MoveLibraryDown(int libraryId)
        {
            using var connection = new SqliteConnection(_connectionString);
            connection.Open();
        ...
        public async Task MoveLibraryDownAsync(int libraryId)
        {
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
            ...
            getNextCommand.CommandText = "SELECT Id, DisplayOrder FROM Libraries WHERE DisplayOrder > @order ORDER BY DisplayOrder ASC LIMIT 1";
            getNextCommand.Parameters.AddWithValue("@order", currentOrderValue);
            using var nextReader = await getNextCommand.ExecuteReaderAsync();
        ...
        public void AddLibraryPath(int libraryId, string path, string displayName = null)
        {
            using var connection = new SqliteConnection(_connectionString);
            connection.Open();
            using var command = connection.CreateCommand();
        ...
        public async Task AddLibraryPathAsync(int libraryId, string path, string displayName = null)
        {
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
            using var command = connection.CreateCommand();
        ...
        public void RemoveLibraryPath(int libraryId, string path)
        {
            using var connection = new SqliteConnection(_connectionString);
            connection.Open();
            using var command = connection.CreateCommand();
        ...
        public async Task RemoveLibraryPathAsync(int libraryId, string path)
        {
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
            using var command = connection.CreateCommand();
        ...
        public void UpdateLibraryPathDisplayName(int libraryId, string path, string displayName)
        {
            using var connection = new SqliteConnection(_connectionString);
            connection.Open();
            using var command = connection.CreateCommand();
        ...
        public async Task UpdateLibraryPathDisplayNameAsync(int libraryId, string path, string displayName)
        {
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
            using var command = connection.CreateCommand();
        ...
        public List<LibraryPath> GetLibraryPaths(int libraryId)
        {
            ...
            while (reader.Read())
            {
                paths.Add(new LibraryPath { Id = reader.GetInt32(0), LibraryId = libraryId, Path = reader.GetString(1), DisplayName = reader.IsDBNull(2) ? null : reader.GetString(2) });
            }
            return paths;
        }

        public async Task<List<LibraryPath>> GetLibraryPathsAsync(int libraryId)
        {
            var paths = new List<LibraryPath>();
            using var connection = new SqliteConnection(_connectionString);
            await connection.OpenAsync();
